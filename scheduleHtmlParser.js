                    ...
                    if (count == 1){
                      ...
                      for(j = 0;j<=info.length+1;j++){
                        ...
                        if(info[j] != '---------------------'){
                          ...
                          if(result[result_len-1]['name'] == course['name'] && result[result_len-1]['position'] == course['position'] && result[result_len-1]['teacher'] == course['teacher'] && result[result_len-1]['weeks'].toString() != course['weeks'] && result[result_len-1]['day'] == course['day'] ){
                            //然后把course里的weeks和result[result_len-1]的weeks合并
                            result[result_len-1]['weeks'] = result[result_len-1]['weeks'].concat(course['weeks'])
                            console.log(result[result_len-1]['weeks'])
                          }else{
                            result.push(course)
                          }
                          z = 0
